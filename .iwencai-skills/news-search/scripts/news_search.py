#!/usr/bin/env python3
"""Call the Iwencai news search API and pass through the raw body."""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Search finance news through the Iwencai OpenAPI gateway.",
    )
    parser.add_argument("query", help="Natural-language news search query.")
