...
SKILL_NAME = "hithink-insresearch-query"
SKILL_VERSION = "1.0.0"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="问财机构研究与评级 - 机构研究与评级数据查询工具",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=f"""
使用示例:
  python3 scripts/cli.py --query "同花顺研报评级"
  python3 scripts/cli.py --query "业绩预测"
  python3 scripts/cli.py --query "券商金股" --page "2" --limit "20"
  python3 scripts/cli.py --query "ESG评级高的股票" --api-key "your-key"
