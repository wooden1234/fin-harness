#!/usr/bin/env python3
"""Call the Iwencai report search API and pass through the raw body."""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Search finance research reports through the Iwencai OpenAPI gateway.",
    )
    parser.add_argument("query", help="Natural-language research report search query.")
