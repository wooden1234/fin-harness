...
8. 查询 annual_financial_facts 时必须携带 PDF 溯源列，并使用以下标准别名：company_id、company_name、ticker、fiscal_year、period_year、period_label、period_type、metric_name、raw_value、value、unit、currency、source、page_num、doc_id、document_id、table_id、source_cell_id、section
